    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('VISIT_CREATED', 'Visit Created'), ('VISIT_CANCELED', 'Visit Canceled'), ('OTHER', 'Other')], default='OTHER', max_length=20)),
